...
var _user$project$Draw$vLine = F3(
	function (start, end, x) {
		return A2(
			...
			{ctor: '_Tuple2', _0: x, _1: start},
			{ctor: '_Tuple2', _0: x, _1: end});
	});
var _user$project$Draw$hLine = F3(
	function (start, end, y) {
		return A2(
			_evancz$elm_graphics$Collage$segment,
			{ctor: '_Tuple2', _0: start, _1: y},
			{ctor: '_Tuple2', _0: end, _1: y});
	});

var _user$project$Kanji$downLeftCurve = A3(
...
var _user$project$Kanji$furui = {
	...
	_1: {
		ctor: '::',
		_0: A3(_user$project$Draw$vLine, 100, 0, 0),
		_1: {
			ctor: '::',
			_0: A3(_user$project$Draw$vLine, 0, -65, -60),
			_1: {
				ctor: '::',
				_0: A3(_user$project$Draw$hLine, -60, 60, 0),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Draw$vLine, 0, -65, 60),
					_1: {
...
var _user$project$Kanji$ta = {
	...
	_1: {
		ctor: '::',
		_0: A3(_user$project$Draw$hLine, -100, 100, 100),
		_1: {
			ctor: '::',
			_0: A3(_user$project$Draw$vLine, 100, -100, 100),
			_1: {
				ctor: '::',
				_0: A3(_user$project$Draw$vLine, 100, -100, 0),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Draw$hLine, -100, 100, 0),
					_1: {
						ctor: '::',
						_0: A3(_user$project$Draw$hLine, -100, 100, -90),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Kanji$tsuki = {
	ctor: '::',
	_0: A3(
		_user$project$Draw$curvedLine,
		{ctor: '_Tuple2', _0: -60, _1: 100},
		{ctor: '_Tuple2', _0: -80, _1: -100},
		8),
	_1: {
		ctor: '::',
		_0: A3(_user$project$Draw$hLine, -60, 60, 100),
		_1: {
			ctor: '::',
			_0: A3(_user$project$Draw$vLine, 100, -100, 60),
			_1: {
				ctor: '::',
				_0: A3(_user$project$Draw$hLine, -60, 60, 50),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Draw$hLine, -60, 60, 0),
					_1: {
						ctor: '::',
						_0: A3(_user$project$Draw$hLine, 60, 40, -100),
						_1: {ctor: '[]'}
					}
				}
			}
	...
	_1: {
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A3(_user$project$Draw$hLine, -60, 60, -90),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Kanji$juu = {
	ctor: '::',
	_0: A3(_user$project$Draw$hLine, -60, 60, 0),
	_1: {
		ctor: '::',
		_0: A3(_user$project$Draw$vLine, 60, -80, 0),
		_1: {ctor: '[]'}
	}
};
var _user$project$Kanji$kyuu = {
	ctor: '::',
	_0: _user$project$Kanji$downLeftCurve,
	_1: {
		ctor: '::',
		_0: A3(_user$project$Draw$hLine, -60, 30, 30),
		_1: {
			ctor: '::',
			_0: _evancz$elm_graphics$Collage$path(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 30, _1: 30},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 30, _1: -55},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 35, _1: -60},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 50, _1: -60},
								_1: {
									ctor: '::',
...
var _user$project$Kanji$roku = {
	...
	_1: {
		ctor: '::',
		_0: A3(_user$project$Draw$hLine, -60, 60, 30),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$elm_graphics$Collage$segment,
...
var _user$project$Kanji$go = {
	...
	_1: {
		...
		_0: A2(
			...
			{ctor: '_Tuple2', _0: -40, _1: -80}),
		_1: {
			ctor: '::',
			_0: A3(_user$project$Draw$hLine, -60, 50, 0),
			_1: {
				ctor: '::',
				_0: A3(_user$project$Draw$vLine, 0, -80, 50),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Draw$hLine, -80, 80, -80),
					_1: {ctor: '[]'}
				}
			}
		}
		...
		_1: {
			...
			_1: {
				...
				_0: _evancz$elm_graphics$Collage$path(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: -20, _1: 100},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: -30, _1: 50},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: -50, _1: 0},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: -80, _1: -50},
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Kanji$san = {
	ctor: '::',
	_0: A3(_user$project$Draw$hLine, -100, 100, 80),
	_1: {
		ctor: '::',
		_0: A3(_user$project$Draw$hLine, -80, 80, 0),
		_1: {
			ctor: '::',
			_0: A3(_user$project$Draw$hLine, -100, 100, -80),
			_1: {ctor: '[]'}
...
var _user$project$Kanji$ni = {
	ctor: '::',
	_0: A3(_user$project$Draw$hLine, -80, 80, 50),
	_1: {
		ctor: '::',
		_0: A3(_user$project$Draw$hLine, -100, 100, -50),
		_1: {ctor: '[]'}
	}
};
var _user$project$Kanji$ichi = {
	ctor: '::',
	_0: A3(_user$project$Draw$hLine, -100, 100, 0),
	_1: {ctor: '[]'}
};
var _user$project$Kanji$kanjiList = {
	ctor: '::',
	_0: _user$project$Kanji$ichi,
	_1: {
		ctor: '::',
		_0: _user$project$Kanji$ni,
		_1: {
			ctor: '::',
			_0: _user$project$Kanji$san,
			_1: {
				ctor: '::',
				_0: _user$project$Kanji$yon,
				_1: {
					ctor: '::',
					_0: _user$project$Kanji$go,
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Kanji$kyuu,
									_1: {
										ctor: '::',
										_0: _user$project$Kanji$juu,
										_1: {
											ctor: '::',
											_0: _user$project$Kanji$kuchi,
											_1: {
												ctor: '::',
												_0: _user$project$Kanji$hi,
												_1: {
													ctor: '::',
													_0: _user$project$Kanji$tsuki,
													_1: {
														ctor: '::',
...
var _user$project$Main$lineStyle = _elm_lang$core$Native_Utils.update(
	_evancz$elm_graphics$Collage$defaultLine,
	{width: 5, cap: _evancz$elm_graphics$Collage$Round});
var _user$project$Main$displayKanji = function (kanji) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Main$boxStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _evancz$elm_graphics$Element$toHtml(
				A3(
					...
					A2(
						_elm_lang$core$List$map,
						_evancz$elm_graphics$Collage$traced(_user$project$Main$lineStyle),
						kanji))),
			_1: {ctor: '[]'}
		});
};
